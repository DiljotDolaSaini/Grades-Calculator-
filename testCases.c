...
//=========Question 1==================================
	...
	void TestQ1_emptyadded(CuTest *tc) {
...
//=================Question 2================================
	...
	void TestQ2_find_added(CuTest *tc) {
		...
		int expected = 0;
		int actual = find(123,Clist,size);

		CuAssertIntEquals(tc, expected, actual);

	}

	void TestQ2_withdrawtest(CuTest *tc) {
			...
			int expected[4] = {4580,6547,7000,9000};
			int actual[5] = {} ;
...
//				printf("%d,",actual[i]);
	...
	void TestQ2_inputGradesAndCalculateFinaladded(CuTest *tc) {
...
//=================Question 3================================
	...
	void TestQ3_readandSort3(CuTest *tc) {
			...
			char *expectedList[]={"done","fan","fun","sun"};
...
//===========================================================
	CuSuite* Lab3GetSuite() {
		...
		SUITE_ADD_TEST(suite, TestQ1_emptyadded); //added


		SUITE_ADD_TEST(suite, TestQ2_find_notThere);
		SUITE_ADD_TEST(suite, TestQ2_find_There);
		SUITE_ADD_TEST(suite, TestQ2_find_added); //added
		SUITE_ADD_TEST(suite, TestQ2_withdrawtest); //added
		SUITE_ADD_TEST(suite, TestQ2_inputGradesAndCalculateFinal);
		SUITE_ADD_TEST(suite, TestQ2_inputGradesAndCalculateFinaladded); //added

		SUITE_ADD_TEST(suite, TestQ3_readandSort1);
		SUITE_ADD_TEST(suite, TestQ3_readandSort2);
		SUITE_ADD_TEST(suite, TestQ3_readandSort3); //added
		SUITE_ADD_TEST(suite, TestQ3_readandSort4); //added
